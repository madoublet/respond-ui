...
export class FormService {
  ...
  private _listUrl = environment.apiUrl + '/api/forms/list';
  private _addUrl = environment.apiUrl + '/api/forms/add';
  private _editUrl = environment.apiUrl + '/api/forms/edit';
  private _removeUrl = environment.apiUrl + '/api/forms/remove';
