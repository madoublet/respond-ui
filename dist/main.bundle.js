...
var AccountComponent = (function () {
    ...
    AccountComponent.prototype.unsubscribe = function () {
        ...
        this._siteService.unsubscribe()
            .subscribe(function (data) { console.log(data); }, function (error) { _this.failure(error); });
